document.getElementById('generateMediumButton').addEventListener('click', generateRandomPhases);
...
function generateRandomPhases() {
  ...
  for (var i = 1; i <= 10; i++) {
    ...
    var phaseText2 = randomPhase2.replace("{num}", '<span class="phase-number-italic">' + getRandomNumber(2, 5) + '</span>');
